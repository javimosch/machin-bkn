...
// bkn.log is a FUNCTION on the published surface and was an object here, so a
// script from the documentation threw. It is now both: callable, with the
// three levels hung off it, because scripts in this repo were written against
// the object form. Same for bkn.id.
"function log(m, d) { __call('log', ['info', m, d || null]); }\n"
"log.info  = function (m, d) { __call('log', ['info', m, d || null]); };\n"
"log.warn  = function (m, d) { __call('log', ['warn', m, d || null]); };\n"
"log.error = function (m, d) { __call('log', ['error', m, d || null]); };\n"
"var crypto = {\n"
"  hmac: function (k, m) { return __call('crypto.hmac', [k, m]); },\n"
"  hash: function (m) { return __call('crypto.hash', [m]); },\n"
"  sha256: function (m) { return __call('crypto.sha256', [m]); },\n"
"  base64Encode: function (m) { return __call('crypto.base64Encode', [m]); },\n"
"  base64Decode: function (m) { return __call('crypto.base64Decode', [m]); },\n"
"  equal: function (a, b) { return __call('crypto.equal', [a, b]); },\n"
"  randomHex: function (n) { return __call('crypto.randomHex', [n || 16]); } };\n"
"function id() { return __call('id.new', []); }\n"
"id.new = function () { return __call('id.new', []); };\n"
...
"  collections: function (ns) { return __call('store.collections', [ns || '']); } };\n"
"var kv = {\n"
...
"  stats: function (s, by) { return __call('events.stats', [s, by || 'type']); } };\n"
// Every one of these was declared here and unimplemented on the host side, so
// bkn.files.list threw "unknown host capability". Nothing caught it because no
// script in this repo called them and the acceptance suite uploads over HTTP.
"var files = {\n"
"  put: function (ns, n, b, o) { return __call('files.put', [ns, n, b, o || {}]); },\n"
"  get: function (ns, n) { return __call('files.get', [ns, n]); },\n"
"  show: function (ns, n) { return __call('files.show', [ns, n]); },\n"
"  list: function (ns) { return __call('files.list', [ns]); },\n"
"  namespaces: function () { return __call('files.namespaces', []); },\n"
...
"  renew: function (k, owner, ttl) { return __call('lock.renew', [k, owner, ttl || 300]); } };\n"
"var auth = {\n"
"  me: function (t) { return __call('auth.me', [t]); },\n"
"  can: function (u, o, r) { return __call('auth.can', [u, o, r]); },\n"
"  createUser: function (e, p, o) { return __call('auth.createUser', [e, p, o || {}]); },\n"
"  findUser: function (u) { return __call('auth.findUser', [u]); },\n"
"  updateUser: function (u, o) { return __call('auth.updateUser', [u, o || {}]); },\n"
"  deleteUser: function (u) { return __call('auth.deleteUser', [u]); },\n"
"  createOrg: function (s, n) { return __call('auth.createOrg', [s, n || '']); },\n"
"  orgs: function () { return __call('auth.orgs', []); },\n"
"  addMember: function (o, u, r) { return __call('auth.addMember', [o, u, r || 'member']); },\n"
"  removeMember: function (o, u) { return __call('auth.removeMember', [o, u]); },\n"
"  members: function (o) { return __call('auth.members', [o]); },\n"
